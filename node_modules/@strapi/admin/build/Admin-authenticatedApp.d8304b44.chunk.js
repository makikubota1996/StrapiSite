"use strict";(self.webpackChunk_strapi_admin=self.webpackChunk_strapi_admin||[]).push([[801],{19782:(k,M,n)=>{n.r(M),n.d(M,{default:()=>tn});var e=n(32735),i=n(88425),b=n(84968),P=n(33795),X=n.n(P);const C={i8:"4.4.7"};var $=n(775),p=n(5141),N=n(4409),D=n(74506),K=n(51968),F=n(88311),G=n.n(F),O=n(58107),T=n(19615),U=n(60216),r=n.n(U),d=n(5636),v=n(64410),E=n(54742),f=n(19192),R=n(9808),J=n(90662),Ne=n(20763),re=n(44526),Ge=n(94009),Ue=n.n(Ge);const Fe=(0,T.default)(f.Flex)`
  position: fixed;
  z-index: 4;
  inset: 0;
